...
<div id="container">
	...
	<div class="minicontainer mc-l">
		...
		if(ViewData.Model.SeccionID==0){
			...
			%>Editar P&aacute;gina > <%=Html.Encode(ViewData.Model.Parent.Nombre)+" > "+Html.Encode(ViewData.Model.Nombre)%><%
		}
		%></h1>
        	...
        	<div class="minicontainer-sub-s mcss-left">
        		<fieldset class="styled-fieldset">
                	<ul>
                        ...
                        <li><label>Nombre de P&aacute;gina *</label><input type="text" class="sti-l" data-bind="disable:id() == 11 || id()==31, value:nombre" id="txtNombre" maxlength="100"/>
        ...
        <div class="minicontainer-sub-s">
            <fieldset class="styled-fieldset">
                <ul>
                    ...
                    <li>
                        <label>Secci&oacute;n Asociada *</label>
                        <div class="styled-select-l"><select id="selectParent" size="1" data-bind="value:subparent, foreach:secciones">
                        <!-- ko if: parentS == false -->
						<option data-bind="value:id,text:nombre"></option>
                        <!-- /ko -->
						</select></div>
                        <span class="mensaje-negativo" style="display:none" associatedControl="selectParent" id="errorParent">Error: Debe elegir la seccion a la cual pertenece la pagina.</span>
                    </li>
                    <li><label>Color asociado</label>
                        <select  size="1" data-bind="value:color, attr: { 'class': color }" style="border:solid 1px black">
                        <option value="" class="" style="background-color:white">Respetar el de la secci&oacute;n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
						  ...
						  <div class="alerta-azul" style="background-image:url(/Content/CSS/Back/icons/information.png); width:auto; margin-left:10px;">La primer foto de la fila, sera siempre la foto representativa en las vistas previas. Desplaze una foto por delante de otra, para cambiar su orden en la fila.</div>
                        	<ul class="prodpic" data-bind="foreach: images" style="padding-left: 60px;">
                        		<li data-bind="attr: { class: $index() % 2 == 0? 'prodpicfirst' : ''}">
                                    ...
                                    <div class="descripcionimagen" data-bind="visible:showdescription" style="margin-top:5px"><label>Descripci&oacute;n</label>&nbsp;<input type="text" class="sti-l" data-bind="value:descripcion" style="width:80%"/></div>
                        			<ul>
                        				<li>
            ...
            <fieldset class="styled-fieldset styled-fieldset-border" style="padding-left:10px"><legend>Archivos</legend>
                	<ul>
                        ...
                        <li><fieldset class="sub-fieldset" >
                        	...
                        	<ul class="proddoc" data-bind="foreach: archivos" style="padding-left: 4px;">
                        		<li data-bind="attr: { class: $index() % 2 == 0? 'prodpicfirst' : ''}">
...
var ViewModel = function(){
    ...
    self.texto='';
    self.token='';
    self.subparent = ko.observable(<%=(ViewData.Model.Parent==null?0:ViewData.Model.Parent.SeccionID)%>);
    self.sub= true;
    self.pyme=false;
