      ...
      <form class="search">
        ...
        <!-- NIVEL 3 - FIN BUSQUEDA -->
            ...
            <div class="sin-resultados">
				<h3>No hay cursos pr&oacute;ximos ni pasados que coincidan con su criterio de b&uacute;squeda.</h3>
    ...
    <div class="toolbox busqueda">
        ...
        <div class="importante">
            ...
            <ul>
            	...
            	<li> Si no encuentra lo que busca por favor escr&iacute;banos a <a href="#">capacitacion@camarco.org.ar</a> para que podamos ayudarlo.</li>
          </ul>
        </div>
