<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Camarco.Model.Delegacion>" %>
...
<div class="wrapper">
    ...
    <p class="content-p">Para ponerse en contacto con la delegaci&oacute;n <%=Html.Encode(Model.Provincia.Nombre) %> de la C&aacute;mara de la Construcci&oacute;n complete el siguiente formulario</p>
    <!-- MODULO CONSULTAS -->
    ...
    <div class="toolbox color03">
        ...
        <div class="importante">
        	...
        	<div class="contacto-agenda">
            	...
            	<p><strong>EMAIL:</strong><a href="mailto:consultas@camarco.org.ar">consultas@camarco.org.ar</a></p>
            </div>
    ...
    $(document).ready(function ()
    {
        $('#btnEnviar').on('click', function (e)
        {
            ...
            if (pass)
            {
                ...
                PageCore.AjaxPost('/Contacto', $.toJSON({ del:<%=Model.DelegacionID %>,na: $('#contactoNA').val(), em: $('#contactoEM').val(), e: $('#contactoE').val(),
