...
namespace Camarco.Web.Controllers
{
	public class SessionController : Controller
	{
		...
		public ActionResult Validate(string data)
		{
			...
			try
			{
				using (PrincipalContext pc = new PrincipalContext(ContextType.Domain, "camarco.org.ar"))
				{
					...
					base.Session["UserID"] = user.DisplayName;
					base.Session["UserName"] = user.DisplayName;
					base.Session["Email"] = ((user.EmailAddress != null) ? user.EmailAddress : "");
